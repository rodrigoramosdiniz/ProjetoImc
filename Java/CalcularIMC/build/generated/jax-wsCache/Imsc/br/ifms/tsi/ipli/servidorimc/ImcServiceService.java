 ...
 * 
 */
@WebServiceClient(name = "ImcServiceService", targetNamespace = "http://servidorimc.ipli.tsi.ifms.br/", wsdlLocation = "http://localhost:8000/Imsc?WSDL")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://localhost:8000/Imsc?WSDL");
